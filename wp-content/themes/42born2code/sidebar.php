...
<?php  $id = get_the_ID();
       if ($id == "5") { ?>
	Facebook: <?php echo esc_attr( get_the_author_meta( 'facebook', $user->ID ) ) . "<br>"; ?>
	Dailymotion: <?php echo esc_attr( get_the_author_meta( 'dailymotion', $user->ID ) ) . "<br>";; ?>
	Mood: <?php echo esc_attr( get_the_author_meta( 'mood', $user->ID ) ); ?>
	</ul>
<?php }
?>
</div><!-- #sidebar -->